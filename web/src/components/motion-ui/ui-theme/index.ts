...
// ==========================================================================
// The default theme — Linear-grade restraint. Short perceived durations with
// no bounce, tight stagger, small travel. Motion is felt as crisp
// responsiveness, never as spectacle. These physics values are Motion's exact
