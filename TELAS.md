...
| 5 | **Revisar** | Resumo (modo, nº de participantes, etapas — incl. as do pacote —, iterações, gerador, juiz, julgamento, nº de chamadas) + **custo estimado** (já inclui gabaritos/duelos) + tema | sempre válido |
